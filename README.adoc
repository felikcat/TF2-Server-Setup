...
WARNING: The server heartbeat checker / watchdog is overcomplicated and the systemd service is flawed. I will correct these once I am no longer stuck using a phone.

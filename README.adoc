...
WARNING: This is being rewritten to use Pyrodactyl instead of LinuxGSM.
...
https://tld-list.com/[TLD-list] is what to use for finding who has the cheapest pricing for a domain. You need at least one domain to professionally host a game server.
